...
- [ ] If TubeAlfred's API changed, I regenerated the contract with `python3 scripts/sync_contract.py --manifest https://tubealfred.com/.well-known/tubealfred-youtube-operations.v1.json --pinned-on YYYY-MM-DD`.
